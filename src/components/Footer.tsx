    ...
    <footer className="bg-gray-50 text-gray-800 border-t border-gray-200">
      ...
      <div className="md:hidden">
        <div className="px-4 py-6">
          ...
          {/* Quick Links - Centered horizontal layout */}
          <div className="mb-6">
            <div className="flex flex-wrap justify-center gap-4 text-center">
              <Link to="/" className="text-gray-600 hover:text-theme-primary transition-colors text-sm">
                Home
              </Link>
              <Link to="/courses" className="text-gray-600 hover:text-theme-primary transition-colors text-sm">
                Courses
              </Link>
              <Link to="/blogs" className="text-gray-600 hover:text-theme-primary transition-colors text-sm">
                Blog
              </Link>
              <Link to="/pricing" className="text-gray-600 hover:text-theme-primary transition-colors text-sm">
                Pricing
              </Link>
              <Link to="/contact" className="text-gray-600 hover:text-theme-primary transition-colors text-sm">
                Contact
              </Link>
            </div>
          </div>
          ...
          {/* Copyright - Better spacing to avoid floating button overlap */}
          <div className="text-center pt-6 pb-20 border-t border-gray-300">
